...
if [[ -z "${EXCLUDE_LIST}" ]]; then
    wget https://raw.githubusercontent.com/paweldabrowa/pure-codeship-continuous-deployment/main/exclude-list.txt
else
...
wget --output-document=.gitignore https://raw.githubusercontent.com/paweldabrowa/pure-codeship-continuous-deployment/main/gitignore-template.txt
